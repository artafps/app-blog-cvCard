    ...
    return (<Fragment>
        ...
        <div className="app app-auth-lock-screen align-content-stretch d-flex flex-wrap justify-content-end">
            ...
            <div className="app-auth-container">
                <div className="logo">
                    {/* add logo page */}
                    <span>Login Admin Panel Repo</span>
                </div>
                <p className="auth-description">You can use this source code to create a management panel for your personal sites with the help of GitHub. Thank you for following me on GitHub. </p>
                <p className="auth-description">My Github : github.com/ <a href="https://github.com/artafps" >artafps</a></p>
